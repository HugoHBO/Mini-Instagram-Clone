...
const Create = (props) => {
  ...
  const updateNumberOfPosts = async () => {
    ...
    return await axios.post(url, {
      id: user.id,
      numberOfPosts: user.user_number_of_posts
        ? user.user_number_of_posts + 1
        : 1,
    });
  };
  ...
  const uploadPost = async () => {
    ...
    if (response && response.data && response.data.message) {
      ...
      setHasNewPost(true);
      alert("Su publicación ha sido creada!");
    }
    setIsLoading(false);
    toggleModal(false);
  };
    ...
    <div className="create-post">
      <div className="create-post__content">
        <div className="create-post__container">
          <div className="create-post__title">Nueva publicación</div>
        ...
        <div className="create-post__form">
          ...
          {!postImage && (
            ...
            >
              ...
              <p>Sube tus fotos y videos aquí</p>
            </div>
          )}
          <input
            style={{ display: "none" }}
