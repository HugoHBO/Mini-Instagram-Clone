...
function SignUp(props) {
  ...
  const isSignupValid = ({ fullname, email, password, confirmPassword }) => {
    ...
    if (validator.isEmpty(fullname)) {
      alert("Por favor define un nombre");
      return false;
    }
    if (!validator.isEmail(email)) {
      alert("Por favor define un email");
      return false;
    }
    if (
      ...
      alert(
        "Por favor agrege una contraseña. Debe contener un mínimo de 6 caracteres"
      );
      return false;
    }
  ...
  const signup = async () => {
    ...
    if (isSignupValid({ fullname, email, password, confirmPassword })) {
      ...
      if (response && response.data.message) {
        ...
        alert(`${email} Se ha creado con éxito!`);
      }
      toggleModal(false);
      setIsLoading(false);
    }
    ...
    <div className="signup">
      <div className="signup__content">
        <div className="signup__container">
          <div className="signup__title">Regístrate</div>
        ...
        <div className="signup__form">
          {userAvatar && (
            <div className="signup__user-avatar">
              <div>
          ...
          {!userAvatar && (
            <div
              ...
              className="signup__avatar-picker"
            >
              Imagen de perfil
            </div>
          )}
          <input
            ...
            hidden
          />
          <input type="text" placeholder="Nombre" ref={fullnameRef} />
